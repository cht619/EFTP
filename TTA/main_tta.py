...
from TTA.main_train import refine_cfg, build_solver
...
def parse_args():
    ...
    parser.add_argument('--tta', help='test time augmentation', default=0, type=float)
...
def main(worker_seed=0):
    ...
    cfg.work_dir = os.path.join('./Run', cfg.baseline, cfg.domain)
